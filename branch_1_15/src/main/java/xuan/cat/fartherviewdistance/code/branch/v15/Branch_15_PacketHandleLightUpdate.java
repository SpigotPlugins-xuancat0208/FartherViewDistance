...
public final class Branch_15_PacketHandleLightUpdate {
    ...
    public Branch_15_PacketHandleLightUpdate() {
        try {
    ...
    public PacketPlayOutLightUpdate createLightUpdatePacket(int chunkX, int chunkZ, Branch_15_ChunkLight light) {
        try {
            ...
            for(int sectionY = 0; sectionY < 18; ++sectionY) {
                ...
                if (skyLight != Branch_15_ChunkLight.EMPTY) {
                    if (skyLight == null) {
                ...
                if (blockLight != Branch_15_ChunkLight.EMPTY) {
                    if (blockLight == null) {
